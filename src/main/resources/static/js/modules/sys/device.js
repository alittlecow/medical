$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '设备使用状态（0未使用 1使用中）', name: 'useStatus', index: 'use_status', width: 80 }, 			
			{ label: '是否故障（0正常 1故障）', name: 'isBreakdown', index: 'is_breakdown', width: 80 }, 			
			{ label: '设备使用产生的总金额', name: 'totalMoney', index: 'total_money', width: 80 }, 			
